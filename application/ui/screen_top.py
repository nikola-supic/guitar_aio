...
"background-color: rgba(0,0,0,0);")
        ...
        self.list_monthly_2 = QtWidgets.QListWidget(self.page_yearly)
        self.list_monthly_2.setGeometry(QtCore.QRect(10, 40, 390, 550))
        font = QtGui.QFont()
        font.setFamily("Dubai")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.list_monthly_2.setFont(font)
        self.list_monthly_2.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.list_monthly_2.setStyleSheet("QListWidget#list_songs {\n"
"    color: rgb(72,72,73);\n"
"    background-color: rgba(205,205,205,150);\n"
"    border-radius: 5px;\n"
"    border: 2px solid rgba(157, 121, 95, 255);\n"
...
"    background-color: rgba(157, 121, 95, 255);\n"
"}")
        self.list_monthly_2.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.list_monthly_2.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.list_monthly_2.setWordWrap(False)
        self.list_monthly_2.setObjectName("list_monthly_2")
        item = QtWidgets.QListWidgetItem()
        self.list_monthly_2.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.list_monthly_2.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.list_monthly_2.addItem(item)
...
"background-color: rgba(0,0,0,0);")
    ...
    def retranslateUi(self, TopScreen):
        ...
        __sortingEnabled = self.list_overall.isSortingEnabled()
        self.list_overall.setSortingEnabled(False)
        item = self.list_overall.item(0)
        item.setText(_translate("TopScreen", "#1"))
        item = self.list_overall.item(1)
        item.setText(_translate("TopScreen", "#2"))
        item = self.list_overall.item(2)
        item.setText(_translate("TopScreen", "#3"))
        item = self.list_overall.item(3)
        item.setText(_translate("TopScreen", "#4"))
        item = self.list_overall.item(4)
        item.setText(_translate("TopScreen", "#5"))
        item = self.list_overall.item(5)
        item.setText(_translate("TopScreen", "#6"))
        item = self.list_overall.item(6)
        item.setText(_translate("TopScreen", "#7"))
        item = self.list_overall.item(7)
        item.setText(_translate("TopScreen", "#8"))
        item = self.list_overall.item(8)
        item.setText(_translate("TopScreen", "#9"))
        item = self.list_overall.item(9)
        item.setText(_translate("TopScreen", "#10"))
        item = self.list_overall.item(10)
        item.setText(_translate("TopScreen", "#11"))
        item = self.list_overall.item(11)
        item.setText(_translate("TopScreen", "#12"))
        item = self.list_overall.item(12)
        item.setText(_translate("TopScreen", "#13"))
        item = self.list_overall.item(13)
        item.setText(_translate("TopScreen", "#14"))
        item = self.list_overall.item(14)
        item.setText(_translate("TopScreen", "#15"))
        item = self.list_overall.item(15)
        item.setText(_translate("TopScreen", "#16"))
        self.list_overall.setSortingEnabled(__sortingEnabled)
        ...
        __sortingEnabled = self.list_daily.isSortingEnabled()
        self.list_daily.setSortingEnabled(False)
        item = self.list_daily.item(0)
        item.setText(_translate("TopScreen", "#1"))
        item = self.list_daily.item(1)
        item.setText(_translate("TopScreen", "#2"))
        item = self.list_daily.item(2)
        item.setText(_translate("TopScreen", "#3"))
        item = self.list_daily.item(3)
        item.setText(_translate("TopScreen", "#4"))
        item = self.list_daily.item(4)
        item.setText(_translate("TopScreen", "#5"))
        item = self.list_daily.item(5)
        item.setText(_translate("TopScreen", "#6"))
        item = self.list_daily.item(6)
        item.setText(_translate("TopScreen", "#7"))
        item = self.list_daily.item(7)
        item.setText(_translate("TopScreen", "#8"))
        item = self.list_daily.item(8)
        item.setText(_translate("TopScreen", "#9"))
        item = self.list_daily.item(9)
        item.setText(_translate("TopScreen", "#10"))
        item = self.list_daily.item(10)
        item.setText(_translate("TopScreen", "#11"))
        item = self.list_daily.item(11)
        item.setText(_translate("TopScreen", "#12"))
        item = self.list_daily.item(12)
        item.setText(_translate("TopScreen", "#13"))
        item = self.list_daily.item(13)
        item.setText(_translate("TopScreen", "#14"))
        item = self.list_daily.item(14)
        item.setText(_translate("TopScreen", "#15"))
        item = self.list_daily.item(15)
        item.setText(_translate("TopScreen", "#16"))
        self.list_daily.setSortingEnabled(__sortingEnabled)
        ...
        __sortingEnabled = self.list_monthly.isSortingEnabled()
        self.list_monthly.setSortingEnabled(False)
        item = self.list_monthly.item(0)
        item.setText(_translate("TopScreen", "#1"))
        item = self.list_monthly.item(1)
        item.setText(_translate("TopScreen", "#2"))
        item = self.list_monthly.item(2)
        item.setText(_translate("TopScreen", "#3"))
        item = self.list_monthly.item(3)
        item.setText(_translate("TopScreen", "#4"))
        item = self.list_monthly.item(4)
        item.setText(_translate("TopScreen", "#5"))
        item = self.list_monthly.item(5)
        item.setText(_translate("TopScreen", "#6"))
        item = self.list_monthly.item(6)
        item.setText(_translate("TopScreen", "#7"))
        item = self.list_monthly.item(7)
        item.setText(_translate("TopScreen", "#8"))
        item = self.list_monthly.item(8)
        item.setText(_translate("TopScreen", "#9"))
        item = self.list_monthly.item(9)
        item.setText(_translate("TopScreen", "#10"))
        item = self.list_monthly.item(10)
        item.setText(_translate("TopScreen", "#11"))
        item = self.list_monthly.item(11)
        item.setText(_translate("TopScreen", "#12"))
        item = self.list_monthly.item(12)
        item.setText(_translate("TopScreen", "#13"))
        item = self.list_monthly.item(13)
        item.setText(_translate("TopScreen", "#14"))
        item = self.list_monthly.item(14)
        item.setText(_translate("TopScreen", "#15"))
        item = self.list_monthly.item(15)
        item.setText(_translate("TopScreen", "#16"))
        self.list_monthly.setSortingEnabled(__sortingEnabled)
        ...
        __sortingEnabled = self.list_monthly_2.isSortingEnabled()
        self.list_monthly_2.setSortingEnabled(False)
        item = self.list_monthly_2.item(0)
        item.setText(_translate("TopScreen", "#1"))
        item = self.list_monthly_2.item(1)
        item.setText(_translate("TopScreen", "#2"))
        item = self.list_monthly_2.item(2)
        item.setText(_translate("TopScreen", "#3"))
        item = self.list_monthly_2.item(3)
        item.setText(_translate("TopScreen", "#4"))
        item = self.list_monthly_2.item(4)
        item.setText(_translate("TopScreen", "#5"))
        item = self.list_monthly_2.item(5)
        item.setText(_translate("TopScreen", "#6"))
        item = self.list_monthly_2.item(6)
        item.setText(_translate("TopScreen", "#7"))
        item = self.list_monthly_2.item(7)
        item.setText(_translate("TopScreen", "#8"))
        item = self.list_monthly_2.item(8)
        item.setText(_translate("TopScreen", "#9"))
        item = self.list_monthly_2.item(9)
        item.setText(_translate("TopScreen", "#10"))
        item = self.list_monthly_2.item(10)
        item.setText(_translate("TopScreen", "#11"))
        item = self.list_monthly_2.item(11)
        item.setText(_translate("TopScreen", "#12"))
        item = self.list_monthly_2.item(12)
        item.setText(_translate("TopScreen", "#13"))
        item = self.list_monthly_2.item(13)
        item.setText(_translate("TopScreen", "#14"))
        item = self.list_monthly_2.item(14)
        item.setText(_translate("TopScreen", "#15"))
        item = self.list_monthly_2.item(15)
        item.setText(_translate("TopScreen", "#16"))
        self.list_monthly_2.setSortingEnabled(__sortingEnabled)
